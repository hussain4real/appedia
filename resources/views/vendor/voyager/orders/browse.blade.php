               ...
               <div class="table-responsive">
                  <table id="dataTable" class="table table-hover">
                     ...
                     <tbody>
                        ...
                        {{-- logic for show colors for order status --}}
                        <tr
                           class="{{$data->status == 'pending' ? 'order-pending': ''}} {{$data->shipped ? 'order-shipped': ''}}">
                           @if($showCheckboxColumn)
                           <td>
                           ...
                           <td>
                              ...
                              => $dataTypeContent, 'content' => $data->{$row->field}, 'action' => 'browse', 'view' =>
