...
<div class="products-section container">
    ...
    <div>
        <div class="products-header">
            ...
            <div>
                <strong>Price</strong>
                <a href="{{route('products.index', ['category' => request()->category, 'sort' => 'low_high'])}}">Low to
                    High</a>
                <a href="{{route('products.index', ['category' => request()->category, 'sort' => 'high_low'])}}">High to
                    Low</a>
            </div>
        </div>
        <div class="products text-center">
            ...
            <div class="product">
                <div class="rating-comment">
                    {{-- @forelse($product->getStarRating() as $review) --}}
